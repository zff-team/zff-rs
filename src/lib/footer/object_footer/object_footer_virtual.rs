...
impl HeaderEncryption for ObjectFooterVirtual {
...
impl Encryption for ObjectFooterVirtual {
...
impl EncryptedObjectFooterVirtual {
        ...
        K: AsRef<[u8]>,
    {
        ...
        let (
            ...
            file_footer_segment_numbers,
            file_footer_offsets,
        ) = ObjectFooterVirtual::decode_inner_content(&mut cursor)?;
        Ok(ObjectFooterVirtual::new(
            self.object_number,
            creation_timestamp,
            passive_objects,
            root_dir_filenumbers,
