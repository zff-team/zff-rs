...
pub(crate) const ERROR_MISSING_SEGMENT: &str = "A segment is missing.";
pub(crate) const ERROR_REWRITE_MAIN_HEADER: &str = "An error occurred while trying to rewrite the main header to the output file. The written data length specified is not correctly listed in the header.";
