...
// - external
use aes::cipher::block_padding::Error as AesBlockpaddingError;
...
use redb::{
    CommitError as RedbCommitError, DatabaseError as RedbError, StorageError as RedbStorageError,
    TableError as RedbTableError, TransactionError as RedbTransactionError,
};
...
impl ZffError {
    ...
    ///        }
    /// }
    pub fn new<S: Into<String>>(kind: ZffErrorKind, details: S) -> Self {
        Self {
            kind,
            source: None,
            details: details.into(),
