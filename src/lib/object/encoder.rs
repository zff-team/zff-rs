...
// - internal
use crate::prelude::*;
use crate::{LogicalObjectEncoder, PhysicalObjectEncoder, PreparedChunk, VirtualObjectEncoder};
...
impl<R: Read> ObjectEncoder<R> {
    ...
    pub(crate) fn get_next_data<D: ReadAt>(
        ...
        match self {
            ...
            ObjectEncoder::Logical(obj) => {
                obj.get_next_data(current_offset, current_segment_no, deduplication_metadata)
            }
